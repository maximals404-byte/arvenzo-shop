  ...
  return (
    <div className="bg-arvenzo-light min-h-screen">
      <div className="max-w-3xl mx-auto px-5 sm:px-8 pt-[100px] pb-24">
        ...
        <p className="text-arvenzo-muted font-sans mb-12">Vragen, opmerkingen of samenwerken? We horen graag van je.</p>

        <div className="grid sm:grid-cols-2 gap-10">
          {/* Contact info */}
          <div className="space-y-6">
            <div>
              <p className="text-[10px] font-sans font-medium uppercase tracking-[0.2em] text-arvenzo-muted mb-3">E-mail</p>
              <a href="mailto:info@arvenzo.be" className="font-heading font-semibold text-arvenzo-ink hover:text-arvenzo-brown transition-colors">
                info@arvenzo.be
              </a>
            </div>
            <div>
              <p className="text-[10px] font-sans font-medium uppercase tracking-[0.2em] text-arvenzo-muted mb-3">Adres</p>
              <p className="font-sans text-sm text-arvenzo-ink leading-relaxed">
                Van Eylen Jonas<br />
            ...
            <div>
              <p className="text-[10px] font-sans font-medium uppercase tracking-[0.2em] text-arvenzo-muted mb-3">Reactietijd</p>
              <p className="font-sans text-sm text-arvenzo-muted">Wij antwoorden binnen 1–2 werkdagen.</p>
            </div>
            <div>
              <p className="text-[10px] font-sans font-medium uppercase tracking-[0.2em] text-arvenzo-muted mb-3">Volg ons</p>
